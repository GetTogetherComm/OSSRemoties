...
BLOG_AUTHOR = "Michael Hall"  # (translatable)
BLOG_TITLE = "OSS Remoties"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://ossremoties.org/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://ossremoties.org/"
BLOG_EMAIL = "mhall119@gmail.com"
BLOG_DESCRIPTION = "A place for remote workers from across the Open Source ecosystems to have casual conversations during their work days"  # (translatable)
